...
function createGastronomistProfile(req, res, next){
...
function readGastronmistProfile(req, res, next){
...
function readAllGastronomistProfiles(req, res, next){
...
function updateGastronomistProfile(req, res, next){
...
function deleteGastronomistProfile(req, res, next){
...
exports.createGastronomist   = createGastronomistProfile;
exports.readGastronomist     = readGastronmistProfile;
exports.readAllGastronomist  = readAllGastronomistProfiles;
exports.updateGastronomist   = updateGastronomistProfile;
exports.deleteGastronomist   = deleteGastronomistProfile;